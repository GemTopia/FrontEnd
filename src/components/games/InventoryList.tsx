    ...
    if(props.gameItems[0]){
        ...
        return (
          <div className={style["list-container"]}>
            ...
            <FontAwesomeIcon icon={faCircleExclamation} className={`${style["warning-icon"]} ${style['blue-icon']}`} />
            <p className={style['list-description']}>if you stay among the top players in each game by the end of the day yow will earn Gemyto .</p>
            </div>
            }
          </div>
        );
        ...
        return(
          <div className={style["list-container"]}>
            <p className={style['list-title']}>{props.title}</p>
            <p className={style['no-game-warning']}>You haven’t played any games today .</p>
          </div>
        );
    }
    else{
      return(
        <div className={style["list-container"]}>
            <p className={style['list-title']}>{props.title}</p>
        <p className={style['no-game-warning']}>You haven’t earned any tokens yet.
        </p>
        </div>
      );
    }
