    ...
    <div className={style.container}>
      ...
      <div className={style["descriptions-container"]}>
        ...
        <p className={style.description}>
          ...
          Likewise, if the game has any problems or bugs. It can report so that
          site admins can track it.
        </p>
        ...
        <p className={style.description}>
          ...
          However, you should note that sending information over the Internet is
          always risky and no security system is 100% secure. For this reason,
          we do not make any guarantees regarding the absence of unauthorized
          access or hacking of your information. <br /> <br />
          ...
          suspect that your security account is incorrect, you must notify us so
          that we can take the necessary measures. <br /> <br />
          Note that the user can register only one email on the site and cannot
          change the email due to the protection of user information.
        </p>
        ...
        <p className={style.description}>
          ...
          site or its contents that leads to the failure of the site, disruption
          of the operation of the site or the use of our services is prohibited.
          <br />
          <br />
          YOU AGREE THAT WE AND OUR EMPLOYEES AND AGENTS SHALL NOT BE LIABLE FOR
          ANY DAMAGES OF ANY KIND, INCLUDING INDIRECT, DIRECT, COMPENSATORY,
          SPECIAL OR TOTAL DAMAGES ARISING OUT OF OR INDIRECTLY RELATED TO YOUR
          USE OF THE SITE. This includes damages for loss, business interruption
          and systems failure, or other damages.
          <br />
          <br />
          ...
          blocked or legal measures to be taken against you. Also, any fraud in
          obtaining scores or tokens will be checked by the admins and the user
          will be banned and won't have the received tokens.
          <br />
          <br />
          Unauthorized Prohibition: We use talented and capable developers to
          develop and operate our site, and we can open source the code used by
          the developers. If we include game source codes found from sources
          such as Git on our site, subject to the licenses and restrictions
          specified therein.
          <br />
          <br />
          Fulfillment of obligations: We are committed to respecting the
          intellectual property rights of others and preventing unauthorized use
          of the site's content and resources. If you believe that your
        ...
        <p className={style.description}>
          ...
          improvements to the Services, changes in local laws or other relevant
          factors. <br />
          <br />
          When changes are made to the Site's rules and regulations, we will try
          to communicate these changes in appropriate ways, such as sending
          notices to users via email, posting notices on the Site, or receiving
          confirmation from users when they log into the Site. <br />
          <br />
          By using our site and continuing to use our services after the changes
          are made, you implicitly agree to the changes in the rules and
          regulations of the site. If you do not agree with the changes, you can
          stop using our site.
          <br />
          <br />
        ...
        <p className={style.description}>
          ...
          account or to tokens in case of violation of the rules and regulations
          of the site or any illegal activity carried out by users. This
          includes suspending or cutting access to all or part of the tokens.{" "}
          <br />
          <br />
          Please note that if you have tokens on our site and get banned for any
          reason, you will lose access to your tokens and will not be able to
        ...
        <p className={style.description}>
          ...
          that we will respond to you as soon as possible, but our response time
          may vary and may take some time depending on the volume of requests.
          We strive to provide you with the best support services.
        </p>
