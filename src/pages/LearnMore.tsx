    ...
    <Fragment>
      ...
      <div className={style.container}>
        ...
        <p className={style.description}>
          ...
          user on Gemtopia has a profile where they can add links to their
          social media accounts. They can also choose whether they want others
          to see their rankings and scores.
        </p>
        ...
        <p className={style["token-description"]}>
          ...
          that stage. Once they achieve the record score for the first stage,
          they can try to earn tokens for the subsequent stages. Tokens that are
        ...
        <p className={style.description}>
          Our development team is tirelessly working with dedication, talent,
          and higher goals. Our aim is to enhance the project and provide better
